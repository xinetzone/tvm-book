...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(add_one, tvm_book::AddOne);
...
class IntPairObj : public tvm::ffi::Object {
 public:
  ...
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tvm_book.IntPair", IntPairObj, tvm::ffi::Object);
};
...
TVM_FFI_STATIC_INIT_BLOCK() {
  ...
  // final project
  refl::GlobalDef().def("tvm_book.raise_error", RaiseError);
