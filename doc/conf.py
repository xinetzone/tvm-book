...
extensions = [
    ...
    # Custom extensions
    "_ext.gallery_directive",  # Custom gallery directive
    "xyzstyle",  # Custom theme extension
]
...
# ------------------------------------------------------------------------------------- 
html_theme = 'xyzstyle'  # Theme name for HTML output
...
# ------------------------------------------------------------------------------------- 
html_static_path = ['_static']  # Paths to static files (stylesheets, images, etc.)
html_css_files = [  # Custom CSS files to include
    "css/custom.css",
    "css/tippy.css",
]
...
html_theme_options = {
    # UI features
    "use_sidenotes": True,  # Enable side notes/marginal notes
    "announcement": "👋欢迎进入编程视界！👋",  # Announcement banner
    
    # Repository integration
    "repository_url": f"https://github.com/xinetzone/{project}",
    "use_repository_button": True,  # Show "View on GitHub" button
    "use_source_button": True,  # Show "View Source" button
    "use_edit_page_button": True,  # Show "Edit this page" button
    "use_issues_button": True,  # Show "Report issue" button
    
    # Icon links (social media, badges, etc.)
...
autoapi_dirs = [f"../src/{project.replace('-', "_")}"]  # Directories to generate API docs from
...
# Interactive notebook launch buttons
# ------------------------------------------------------------------------------------- 
# Add buttons to launch notebooks in interactive environments
# These buttons will appear at the bottom of pages

extensions.append("sphinx_thebe")  # Support for interactive code execution

# Update theme options with launch button configurations
...
# Version switcher
# ------------------------------------------------------------------------------------- 
extensions.append("_ext.rtd_version")  # Add version switcher dropdown menu
...
extensions.append("sphinxcontrib.katex")  # Add support for KaTeX math rendering
katex_prerender = True  # Pre-render math formulas for better performance