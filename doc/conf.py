...
bibtex_bibfiles = ['_static/references/book.bib', "_static/references/articles.bib"]
# 自动生成 API 文档的路径
# -------------------------------------------------------------------------------------
...
ogp_social_cards = {
    ...
    # "font": "Noto Sans CJK SC", # 支持中文字体并包含更多符号 apt install fonts-noto-cjk
    "line_colors": "#4078c0",
}
...
katex_prerender = True  # 预渲染公式以提升性能